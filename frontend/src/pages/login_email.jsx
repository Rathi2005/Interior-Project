...
import { loginUser } from "../api/auth_email";
      ...
      <div className="flex flex-col lg:flex-row w-full max-w-4xl bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-6 sm:p-8 md:p-10">
          {!otpStage ? (
            <>
              ...
              <div className="text-center lg:text-left mb-6">
                ...
                <p className="text-sm text-gray-500">
                  Check your order status, update your billing info, and review
                  past orders.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div className="flex justify-between items-center">
                  <a
                    href="#"
                    className="text-sm text-[#b08a44] hover:underline"
                  >
                    Forgot Password?
                  </a>
                </div>
            ...
            <OtpForm email={email} /> // show OTP input form
          )}
